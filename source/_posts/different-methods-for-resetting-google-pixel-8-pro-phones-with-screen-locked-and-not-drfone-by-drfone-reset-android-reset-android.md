---
title: Different Methods for Resetting Google Pixel 8 Pro Phones with Screen Locked and Not | Dr.fone
date: 2024-09-17T18:46:15.606Z
updated: 2024-09-24T17:50:53.044Z
tags: 
  - reset
categories:
  - android
description: This article describes Different Methods for Resetting Google Pixel 8 Pro Phones with Screen Locked and Not
excerpt: This article describes Different Methods for Resetting Google Pixel 8 Pro Phones with Screen Locked and Not
keywords: factory reset,hard reset,soft reset,Google Pixel 8 Pro factory reset,Google Pixel 8 Pro hard reset,Google Pixel 8 Pro soft reset
thumbnail: https://thmb.techidaily.com/078ec5c6b19df307c3d053f03815c7d21ecece8ed3226ebe1d118a70909568e6.jpg
---

## Different Methods for Resetting Google Pixel 8 Pro Phones with Screen Locked and Not

The Google Pixel 8 Pro has made its place in the smartphone industry at a fast pace. Google Pixel 8 Prois dealing with a broad spectrum of products from flagship phones to smartwatches and security cameras. No worries if you own a smartphone owned by the label and don't know how to reset your Google Pixel 8 Prophone without a password.

In the following article, you can learn all about factory resetting Google Pixel 8 Prophones, including an apt checklist of things to do before wiping all the data from your device. Also, discover multiple easy methods to reset a Google Pixel 8 Prophone with or without a password.

## Part 1: When Should You Reset Your Google Pixel 8 Pro?

Performing a factory reset on your phone is a significant step as it wipes all existing data on your device and leaves you with a blank slate. Here are some plausible reasons why you might want to reset your Google Pixel 8 Prophone:
...
Forgetting your phone's password is a catastrophe, and everyone is prone to it. If you end up locking yourself out of your phone after too many attempted tries to unlock it, a hard factory reset is sometimes the only option left. You can learn **how to factory reset your Google Pixel 8 Prophone when locked** and end up with a clean slate without any password.

### 3\. Selling or Replacing Phone

If you choose to sell your Google Pixel 8 Prophone and move on to a new one, you will need to wipe all data from your device. Deleting everything from your phone before changing it is essential to protect the integrity and privacy of your data. In such a situation, you can perform a factory reset, and your phone will be good as new.

### 4\. Virus and Malware Attacks

If a virus or malware attacks your device, it can slow down your phone and put your data at risk. To ensure that no trace of malicious software is left on the Google Pixel 8 Pro device, you will need to perform a factory reset on your Google Pixel 8 Prophone.
...
## Part 2: What Should You Do Before Formatting Your Google Pixel 8 Pro?

If any of the above-mentioned reasons check a box and you wish to format your Google Pixel 8 Prophone, it can be done in a few instants. However, keeping in mind the severity of the consequences, it is better to keep a few things in mind before proceeding with the process.
...
Before formatting your device, you have to keep in consideration Google's Factory Reset Protection (FRP) feature. This is a security feature in Android phones that prevents unauthorized use of devices. FRP makes sure that only the owner of the Google account signed into the Google Pixel 8 Pro device can perform a factory reset on it. If you have forgotten your Google account password, reset it in advance so you can format your phone. Note that you have to wait for 72 hours after changing your Google account's password before formatting a linked phone.

![safe Download](https://images.wondershare.com/drfone/security.svg)safe & secure

## Part 3: How to Factory Reset Google Pixel 8 Pro

If you know the passcode to your device, the procedure to factory reset your device is easy as a breeze. The following methods indicate how to factory reset a Google Pixel 8 Prophone when it is not locked.

### Method 1: Factory Reset Google Pixel 8 Pro via Android Settings (Factory Reset)

The easiest way to perform a complete wipe on your phone is via your phone's settings. Here are the steps for that:

**Step 1:** Go to the settings of your Google Pixel 8 Prophone and scroll down to find the "Factory Reset" option. Typically, this option is under the "About Phone" or "Additional Settings" menu.

![choose factory reset option](https://images.wondershare.com/drfone/article/2022/09/how-to-reset-locked-mi-phone-2.jpg)

**Step 2:** Now click on "Erase all data" at the bottom of your Google Pixel 8 Prophone screen.
...
Now connect your Google Pixel 8 Prophone to your computer via a tethering cable and enable USB debugging on your Google Pixel 8 Prophone.

![tap on start button](https://images.wondershare.com/drfone/guide/android-erase-02.png)

**Step 3: Start Erasing Google Pixel 8 ProDevice**

After attaching your phone to the computer, click on "Start." Now, type in the confirmation code present on the screen and tap on the "Erase Now" button to reset your Google Pixel 8 Prodevice.
...
## Part 4: How to Factory Reset Google Pixel 8 Pro When Locked

If you got locked out of your Google Pixel 8 Prophone, the process to factory reset your phone can differ slightly. The following methods describe **how to factory reset Google Pixel 8 Prophone when locked**.

### Method 1: Via the Recovery Mode

One of the go-to methods for factory resetting a locked Google Pixel 8 Prophone is via the recovery mode. You can follow the steps given below to boot your phone in recovery mode and perform a factory reset on your Google Pixel 8 Prophone without a password:

**Step 1:** Long press the Power button on your Google Pixel 8 Prophone to turn it off. Now press and hold the Power button and the Volume Up button at the same time.

**Step 2:** Once the Google Pixel 8 Prologo appears on the screen and you feel a vibration, let go of the Power button but keep pressing the Volume Up button. Let go once you see the "Recovery Mode" screen on your phone.
...
Xiaomi offers a "Find Device" option, using which you can learn to **factory reset your Google Pixel 8 Prophone without a password** using your Google Pixel 8 Proaccount. Note that for this process to work, you will require an active internet connection and a signed-in Google Pixel 8 Proaccount on your phone. Then, you can perform the following steps to wipe data from your Google Pixel 8 Prophone:

**Step 1:** Launch the official website of Google Pixel 8 Pro and sign in using your Google Pixel 8 Proaccount.
...
The Xiaomi ADB Fastboot Tools is a helpful app that enables users to perform ADB commands quickly and easily. The app comes with a range of beneficial tools that can help you wipe all data from your phone. Following is a step-by-step guide on **how to reset Google Pixel 8 Prophone when locked** using the ADB Fastboot Tools:
...
**Step 2:** Use a USB cable to attach your Google Pixel 8 Prophone to your computer and launch the Xiaomi ADB Fastboot Tools application.

**Step 3:** The app will automatically detect and display the information regarding your Google Pixel 8 Prophone at the top-left corner of the screen.

**Step 4:** Under the "Wiper" section in the app, click on "Wipe cache and user data" to reset your locked Google Pixel 8 Prophone.
...
If you are searching for a reliable way to reset your Google Pixel 8 Prophone without a password, Dr.Fone can come in handy. Using the Screen Unlock feature of the tool, you can easily remove the screen lock and then perform a complete wipe on your device. Here is **how to factory reset a locked Google Pixel 8 Prophone** using [Dr.Fone - Screen Unlock (Android)](https://tools.techidaily.com/wondershare-dr-fone-unlock-android-screen/):
...
**Step 2: Enable Google Pixel 8 ProDownload Mode**
...
**Step 3: Remove Google Pixel 8 ProScreen Completely**

Once the download is complete, click "Remove Now" to access your phone without a passcode. Then, you can factory reset your Google Pixel 8 Prophone from the settings.
...
## Part 5: FAQs about Google Pixel 8 Pro

1. **How can I hard reset my Google Pixel 8 Prophone without a PC?**
...
Google Pixel 8 Prois a famous brand that serves a large number of consumers worldwide. If you are also a Google Pixel 8 Prouser, you now know **how to factory reset your Google Pixel 8 Prophone without a password** owing to the in-depth guide mentioned above. Using these easy methods, such as Dr.Fone for resetting your device, can help save you a great deal of trouble.
...
## Hard Resetting an Google Pixel 8 Pro Device Made Easy

If you have owned any Google Pixel 8 Pro smartphone, you should know about the UI features these handsets offer. The new age of Color OS has been giving the best client experience. Moreover, it is easier to hard reset your Google Pixel 8 Pro phone if you need to sell a phone. This article will guide you on **resetting Google Pixel 8 Pro phone** with simple steps.

We have shared a step-by-step manual on how you can perform **Google Pixel 8 Pro hard reset**. Several methods are mentioned in this article, and all of them are tested. Resetting any Google Pixel 8 Pro phone is not a hard task. You should know about the right steps. However, we suggest you use Dr.Fone - Data Eraser for better results and more commands. It is hassle-free software and lets you selectively delete the desired data from your phone.

## Part 1: Some Common Causes of Google Pixel 8 Pro Hard Reset

There are many occasions when a person may want to hard reset their Google Pixel 8 Pro phone. Some of these are:

- If your Google Pixel 8 Pro runs too slowly, you may need to reset it to clear some space.
...
## Part 2: 2 simple ways to hard reset your Google Pixel 8 Pro

### 1\. Hard Reset from Settings

- **Step 1.** Go to the Settings application on your Google Pixel 8 Pro phone and open System Settings.
...
- **Step 4.** To **hard reset Google Pixel 8 Pro**, pick the Erase All Data option to reset your device and bring it to factory settings.
...
Hard resetting Google Pixel 8 Pro smartphones is also simple, assuming you know the right steps. The following are the steps to get to the recovery mode on Google Pixel 8 Pro smartphones and do an **Oppo hard rese**t. This method is quite helpful when you don't remember your phone's screen lock.

- **Step 1:** Make sure to power off your Google Pixel 8 Pro smartphone to get started. Press and hold the power key on your Google Pixel 8 Pro phone for about 10 seconds.
- **Step 2:** Simultaneously, press and hold the power and Volume down keys until the Google Pixel 8 Pro logo springs up on the screen. This will bring the Recovery mode screen.
...
## Part 3: Best Tools to Make your Google Pixel 8 Pro Hard Reset Easier
...
- **Step 1:** After launching Dr.Fone, please use a USB cable to connect your Google Pixel 8 Pro phone. And tap the “Screen Unlock” option.
...
- **Step 3:** To unlock Google Pixel 8 Pro phone, the left “100% Remove Screen Lock” is the only feasible way. In this interface, we include most android brands. And as Google Pixel 8 Pro user, it’s also in the list we offered.

![select phone model](https://images.wondershare.com/drfone/guide/screen-unlock-any-android-device-2.png)

- **Step 4:** Recovery mode is the key step for the whole process. Here is a simple guide to help you hard reset your Google Pixel 8 Pro device.

![unlock oppo ](https://images.wondershare.com/drfone/guide/unlock-android-screen-google.png)

- Congrats! You’re able to access your Google Pixel 8 Pro phone without hassle and it’s already hard reset!
...
- **Step 2:** Connect your Google Pixel 8 Pro phone to the PC through a USB connector.
