---
title: How to Hard Reset Tecno Spark Go (2023) Without Password | Dr.fone
date: 2024-05-20T10:20:18.108Z
updated: 2024-05-21T10:20:18.108Z
tags: 
  - reset
categories:
  - android
description: This article describes How to Hard Reset Tecno Spark Go (2023) Without Password
excerpt: This article describes How to Hard Reset Tecno Spark Go (2023) Without Password
keywords: factory reset,Tecno Spark Go (2023) factory reset,hard reset,soft reset,Tecno Spark Go (2023) hard reset,Tecno Spark Go (2023) soft reset
thumbnail: https://www.lifewire.com/thmb/mDhxV8MNRpKsVw-MZy5n6Aic8pw=/400x300/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/samsung-soundbar-dolby-atmos-569f1fdd925e46ab8b3e1f51d95e1e6c.jpg
---

## How to Reset Tecno Spark Go (2023) without Losing Data
...
Step 4. If you have done this correctly a little Android robot will appear on your screen as the Tecno Spark Go (2023) device resets itself.
...
It can be quick and scary seeing your phone return to its original state. But don't panic. Your data is still safely tucked away on your computer. To restore your contacts and Apps just connect your Tecno Spark Go (2023) to the Internet and login into your Google account when prompted.
...
- Works perfectly with Apple, Tecno Spark Go (2023), HTC, LG, Sony, Google, HUAWEI, Motorola, ZTE, Tecno Spark Go (2023), and more smartphones and tablets.
...
## All Things You Need to Know about Wipe Data/Factoy Reset For Tecno Spark Go (2023)
...
Doing a factory reset on the Android device will remove all the applications installed on the Tecno Spark Go (2023) device along with the data associated with them. This brings back all the default settings of the Tecno Spark Go (2023) device as it was when the phone was new, giving you a clean slate to start all over again.
...
Step 1: First of all, turn off the Tecno Spark Go (2023) device. Then, use the volume up button, volume down button, and Power button on your Android device simultaneously and hold on to the buttons until the phone turns on.

![boot in recovery mode](https://images.wondershare.com/drfone/article/2017/04/14925873397589.jpg)

Step 2: Release the buttons when the Tecno Spark Go (2023) device is powered on. Now, use the volume up and down button to sift through the options given on the screen. Use the power button to select “Recovery Mode” on the screen. Your phone will restart into “Recovery Mode’ and you will find the below screen:
...
So, to protect your privacy and completely wipe data off the Tecno Spark Go (2023) device, you can use Dr.Fone - Data Eraser. This is an amazing tool that erases everything on the Tecno Spark Go (2023) device without leaving an ounce of data in it. Here’s how you can use [Dr.Fone - Data Eraser](https://tools.techidaily.com/wondershare/drfone/android-data-eraser/) to completely wipe the data and protect privacy:
