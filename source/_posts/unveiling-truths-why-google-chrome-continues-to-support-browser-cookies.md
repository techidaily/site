---
title: "Unveiling Truths: Why Google Chrome Continues to Support Browser Cookies"
date: 2024-09-01T02:14:48.462Z
updated: 2024-09-02T02:14:48.462Z
tags:
  - web
categories:
  - tech
...
Google has been trying to replace web browser tracking cookies with a new ‘Privacy Sandbox’ since 2019\. The company is now reworking that plan again and has decided not to kill browser cookies (for now).
 ...
 Google has been building Privacy Sandbox as a new framework for advertising and cross-site communication [since 2019](https://blog.google/products/chrome/building-a-more-private-web/). A core component of the initial proposal, the Federated Learning of Cohorts (FLoC for short), was widely panned by groups like the [Electronic Frontier Foundation](https://www.eff.org/deeplinks/2021/03/googles-floc-terrible-idea) and [other web browser vendors](https://www.theverge.com/2021/4/16/22387492/google-floc-ad-tech-privacy-browsers-brave-vivaldi-edge-mozilla-chrome-safari) over privacy concerns. Google started reworking it in 2022, replacing FLoC with the Topics API, which was at least marginally more safe for users and still safer than third-party cookies.

 The plan all along has been to kill third-party tracking cookies in Chrome—which would also affect Edge, Vivaldi, and other Chromium based browsers—once the Privacy Sandbox was fully ready to replace all of the use cases for tracking cookies. That process was supposed to start in the first quarter of 2024, and be fully complete by the end of the year, but [Google paused the rollout](https://extra-support.techidaily.com/powerful-strategies-for-optimizing-gratuitous-timer-use-for-2024/) in response to complaints from the web advertising industry and the United Kingdom’s Competition and Markets Authority (CMA).
 ...
 Source: [Google](https://privacysandbox.com/news/privacy-sandbox-update/)
