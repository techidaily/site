---
title: Different Methods for Resetting ZTE Nubia Z60 Ultra Phones with Screen Locked and Not | Dr.fone
date: 2024-09-19T18:01:27.248Z
updated: 2024-09-24T18:45:33.498Z
tags: 
  - reset
categories:
  - android
description: This article describes Different Methods for Resetting ZTE Nubia Z60 Ultra Phones with Screen Locked and Not
excerpt: This article describes Different Methods for Resetting ZTE Nubia Z60 Ultra Phones with Screen Locked and Not
keywords: hard reset,soft reset,ZTE Nubia Z60 Ultra factory reset,ZTE Nubia Z60 Ultra soft reset,factory reset,ZTE Nubia Z60 Ultra hard reset
...
Factory reset will delete all your user data from internal storage. Thus it is also very important to back up all your internal data of the ZTE Nubia Z60 Ultra device before you hard reset Android via PC. Moreover, a hard reset should be your last option at hand to revive your Android device. Hence, in this article for all the users out there, we have picked up the solution on **how to factory reset Android Phone using PC**.
...
**Step 3:** Click on "Backup pow"  to proceed with the process. The backup process will start, keeping connected the ZTE Nubia Z60 Ultra device during the phone backup process.
...
In this process, we will learn how to hard reset Android phone to factory settings from a computer using SDK. This involves removing all data from the ZTE Nubia Z60 Ultra device using a PC.
...
• A USB Cable to connect your ZTE Nubia Z60 Ultra with your computer.
...
**Step 1:** Enable USB Debugging in the Android settings. Open Settings>Developer options>USB Debugging. If developer options can’t be found on the ZTE Nubia Z60 Ultra device, then please go to Settings > General > About phone > Common > Software info (tap on it 5-8 times).
...
**Step 4:** Connect the ZTE Nubia Z60 Ultra device to the PC using a USB cable. Ensure that the ZTE Nubia Z60 Ultra device is recognized in the Windows Device Manager.
...
**Step 6:** Type ADB reboot recovery and the ZTE Nubia Z60 Ultra device will restart. The recovery menu must appear after this

**Step 7:** The device can be disconnected now. Now, you can remove the password or simply Factory Reset the ZTE Nubia Z60 Ultra device.
...
• It must be activated in the ZTE Nubia Z60 Ultra device administrator settings. Go to settings > Security > Device administrators and check whether ADM is enabled as a device administrator or not.  
• The location of the ZTE Nubia Z60 Ultra device must be ON  
...
• Even if the ZTE Nubia Z60 Ultra device is without SIM, the Google account must be active
...
**Step 3:** Click "Secure Device", you can remotely lock your device with a new passcode, display a custom message on the lock screen, and even track the ZTE Nubia Z60 Ultra device's location in real-time. It also gives you the option to add a contact number, so anyone who finds your device can reach out to you.
...
So these were the third different methods through which you can hard reset your Android device. Resetting the ZTE Nubia Z60 Ultra device involves removing every data from the ZTE Nubia Z60 Ultra device. The phone gets back to the same state as it was out of the box. Hence, most importantly, do not forget to back up data using Phone Backup and restore beforehand so that you do not end up losing anything important.
