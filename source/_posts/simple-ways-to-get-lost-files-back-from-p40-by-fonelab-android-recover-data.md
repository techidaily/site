...
keywords: restore deleted data on P40,Itel P40 data lost,undelete data from Itel,broken P40 data recovery solution,save lost data on Itel P40,Regain missing files on P40,how to recover data Itel,data disappear Itel,how to recover data in Itel,how to recover deleted data in Itel P40,P40 reset but recover data,how to retrieve deleted data from my Itel
---
...
<div class="tpl-content-sub-paragraph-question">
  "What a sad thing! Mistakenly I pressed the <b>‘Delete All'</b> button and clicked 'OK' button in my Itel P40, and all of my precious files are gone. How can I get them back? Your help will be pretty appreciated. Thanks!""
</div>
</div>


<ul>
  <li>Part 1: <strong><a href="#p1">Simple ways to get lost files back from P40 (on macOS)</a></strong></li>
  <li>Part 2: <strong><a href="#p2">Simple ways to get lost files back from P40 (on Windows)</a></strong></li>
</ul>
...
<div>
  <span class="atpl-step-part-style">Part 1. Simple ways to get lost files back from P40 (on macOS)</span>
</div>  
...
<!-- Part 2 -->
<div>
  <span class="atpl-step-part-style">Part 2. Simple ways to get lost files back from P40 (on Windows)</span>
</div>
