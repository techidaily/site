---
title: What is a local SERP?
date: 2024-05-20T10:20:07.314Z
tags: 
  - seo
  - rank tracker
categories: 
  - seo tools
  - link-assistant
description: This is a specified type of search results that shows up for a query based on the searcher's location. Local SERPs often contain the local 3-pack at the top and the most relevant results on the map.
keywords: local seo rank tracker,local seo,local rankings,local seo rankings,local seo rank tracking,local seo tool,local seo rank tracking software,local seo rank tracking tool,local seo software,local rank tracker,local serp,local seo rank tracking service
---
