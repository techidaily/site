---
title: Remove Google FRP lock on ThinkPhone
date: 2024-05-20T10:20:27.200Z
updated: 2024-05-21T10:20:27.200Z
tags: 
  - android unlock
...
keywords: Lenovo ThinkPhone unlock,remove google frp lock,remove frp,Lenovo unlock,remove Lenovo frp,ThinkPhone unlock
...
<p>
  ...
  Suppose you are struggling to get into the home screen of your Lenovo tablets or mobile phones, like the Lenovo ThinkPhone. 
  Then, it would be best if you learned the Lenovo ThinkPhone FRP unlock process. 
  The problem is that the Factory Reset Protection (FRP) feature has been activated due to an unsafe factory reset; 
  hence, you will have to bypass Google FRP before utilizing your Lenovo device.
...
The good news is that there is a quick shortcut maker FRP bypass for you to disable the Lenovo ThinkPhone account and enter it into your device's home screen. That is [Dr.Fone – Screen Unlock (Android)](https://tools.techidaily.com/wondershare-dr-fone-unlock-android-screen/). This guide will show you some of the trusted methods you can use to solve this issue.

<ul>
  <li>Part 1: <strong><a href="#p1"> Bypass Google Account of Almost All Lenovo (Including Android 11/12/13) </a></strong></li>
  <li>Part 2: <strong><a href="#p2"> Bypass Google Account on Lenovo with Android 6/9/10 </a></strong></li>
  <li>Part 3: <strong><a href="#p3"> Bypass Google Account on Lenovo with Android 7/8 </a></strong></li>
  <li>Part 4: <strong><a href="#p4"> Not Sure about the Version of the Lenovo Operating System? Check Now! </a></strong></li>
</ul>
...
<div>
  <span class="atpl-step-part-style">Part 1. Bypass Google Account of Almost All Lenovo (Including Android 11/12/13)</span>
</div>  

Removing the **Google account** from a device sounds no difficult and different for you.
However, sometimes it is important to be aware of some details about the smartphone. What if you have bought a used Lenovo device and want to remove its **FRP lock**?
...
Then select **Lenovo** and click the **Start** button to continue.
...
> **NOTE**: Unlocking the FRP (Factory Reset Protection) on a Lenovo device involves performing a factory reset, resulting in data loss. Remember to backup your data before unlocking the FRP to avoid permanent data erasure. 


<!-- Step3 -->
<span class="atpl-stepstyle-a"><span>Step 3: </span></span> Select All Android versions(One-Click Removal)

If you are not aware of the Android OS version of your Lenovo or want to use the quickest way to remove Google Lock, select the option of **All Android versions (One-Click Removal)** and continue by clicking Start on the same screen.
...
> **TIP**: Do you have the latest Lenovo Android 11/12 with you? Although there are few methods available to **Lenovo FRP bypass** Android 11/12, Dr.Fone provides a clear procession to deactivate the Google FRP across your device. You can checkmark the option of **Android OS 11/12** and click **Start** to initiate.
...
Your Android screen will show a prompt to activate USB debugging. After allowing it on your Lenovo device, click Authorized on your computer screen.
...
The next screen on your computer will display the removal of the FRP lock from your Lenovo Android device.
...
<div>
  <span class="atpl-step-part-style">Part 2. Bypass Google Account on Lenovo with Android 6/9/10 </span>
</div>  

If you are sure about your Lenovo OS version, you can also follow the steps below to start the easy FRP bypass now. For Android 6/9/10, resetting the PIN code is a good way to deactivate Google FRP. Here are the steps for you to follow: 
...
The next screen will display a notification sent to your Lenovo ThinkPhone device.
...
As it is sent successfully, the screen will prompt its execution. Click **OK** to continue to the next instructions and get hold of your Lenovo ThinkPhone device.
...
Click the **View** button to open the Lenovo ThinkPhone device Internet Browser and type the required URL in the browser. Then, follow the instructions to select the **PIN** to protect your phone.
...
After that, revert to the **Wi-Fi connect page** on your Lenovo ThinkPhone device and enter the PIN code set. Progress with the on-screen instructions and discover the **Skip** button on the page when you are about to enter the Google account. Click **Next** on your computer screen once done. 
...
<div>
  <span class="atpl-step-part-style">Part 3. Bypass Google Account on Lenovo with Android 7/8 </span>
</div>  

The next steps are used to remove FRP on Lenovo devices running **Android 7/8**. Let's get started now.
...
<!-- Step2 -->
<span class="atpl-stepstyle-a"><span>Step 2: </span></span> Check Notification on Lenovo Device

You will be sent a notification on your Lenovo device, whose progress will be displayed on the screen. Once it is sent successfully, the screen prompts its completion. Click **OK** to continue with the process.
...
For removing FRP, follow all on-screen instructions properly. On clicking **View** on the received notification on the Lenovo device, continue to accept the terms of the Google Chrome browser that opens by clicking **Accept & Continue**. On choosing **No Thanks**, proceed with the next step.
...
Open the required URL and select **Android 7/8**. Continue to click the **Download APK** option to download an APK onto your Lenovo device, which will serve as the key to bypassing the FRP lock.
...
Then, lead back to the browser page and tap the **Open Settings** button. Access your Lenovo device's security settings as instructed, and disable **Android Device Manager** and **Find My Device** to bypass FRP. 
...
Go to the Settings of your Lenovo and look for the **Google Play Services** and **Play Store** options for disabling.
...
<!-- Step7 -->
<span class="atpl-stepstyle-a"><span>Step 7: </span></span> Add a New Google Account on Lenovo


After disabling these settings, proceed to set up an account on your Lenovo device from **Settings > Cloud and Accounts >Accounts**. Then, follow the on-screen instructions to sign in to your **Google Account** or create a new one.
...
After you create/log in to the account and agree with the policy, head back into the similar navigation of security settings on the Lenovo  device to turn it back on.
...
<!-- Step8 -->
<span class="atpl-stepstyle-a"><span>Step 8: </span></span> Reactivate Disabled Services on Lenovo

Firstly, reactivate the services of **Android Device Manager** and **Find My Device**.

Conversely, turn on the services of **Google Play Services** and **Play Store** once again and restart your Lenovo device.
...
<!-- Step9 -->
<span class="atpl-stepstyle-a"><span>Step 8: </span></span> Successfully Remove Android FRP Lock from Lenovo

As you open the device, you will find out that the FRP lock has been successfully removed from the Lenovo device. The screen on the front of your computer also prompts the completion of the entire process.
...
<div>
  <span class="atpl-step-part-style">Part 4. Still Trying to Figure Out the Version of the Lenovo Operating System? Check Now! </span>
</div>  

You can easily know the operating system version of your Lenovo by following the steps below:

<!-- Step1 -->
<span class="atpl-stepstyle-a"><span>Step 1: </span></span> Get into Not Sure the OS Version

If you are not sure about the Android version of your Lenovo, select the option **Not Sure the OS Version** once you access the particular screen.
...
<!-- Step2 -->
<span class="atpl-stepstyle-a"><span>Step 2: </span></span> Put Lenovo Device into Recovery Mode

Follow the instructions to put your Lenovo in Recovery Mode. Select the specific mode according to your device from the top.
...
Once you find out the specific Android version after putting the device in Recovery Mode, continue to select the specific option from the screen and follow the instructions provided in the above parts to do the Lenovo FRP bypass according to your Android version.
