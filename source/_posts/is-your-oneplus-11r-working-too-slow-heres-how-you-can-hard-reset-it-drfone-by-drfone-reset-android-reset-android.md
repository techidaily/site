---
title: Is your OnePlus 11R working too slow? Heres how you can hard reset it | Dr.fone
date: 2024-05-20T10:20:26.533Z
updated: 2024-05-21T10:20:26.533Z
tags: 
  - reset
categories:
  - android
description: This article describes Is your OnePlus 11R working too slow? Heres how you can hard reset it
excerpt: This article describes Is your OnePlus 11R working too slow? Heres how you can hard reset it
keywords: hard reset,OnePlus 11R soft reset,OnePlus 11R factory reset,soft reset,OnePlus 11R hard reset,factory reset
thumbnail: https://www.lifewire.com/thmb/o9Q9WuSk80JXjgUWGQkyTXmmm-M=/400x300/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/GettyImages-1088144728-3a9f1bd54e994bfaa4cabea82414202e.jpg
---

## Is your OnePlus 11R working too slow? Here's how you can hard reset it

If OnePlus 11R 3.4 hard reset or OnePlus 11R hard reset is the only option for your mobile phone, you can perform a factory reset to make your device function as it did on the first day. You may need a hard reset if it works slowly, hangs, you want to bypass screen lock, your memory is full, and you want to erase everything, you want to sell or give your device away, and you don't want anyone to be able to access your files or passwords.

The following instructions will show you how to completely wipe up all of your data and restore the OnePlus 11R to its factory-fresh condition.

## Part 1: Why do I Need to Hard Reset My OnePlus 11R?

We advise you to remove all accounts from the OnePlus 11R device before performing a factory reset, especially if you plan to sell, give away, or donate the 3.4. It is also a good idea to unlink the Google account. By doing this, we can prevent issues for new users as some more recent smartphones have a feature called FRP, or Factory Reset Protection, which requires the Google account or PIN number that was originally used to set up the OnePlus 11R when a device is factory restored.

## Part 2: How to Hard Reset My OnePlus 11R

### 1\. Fastboot Mode

- Shut down your phone.
- Add a USB cord to your computer or laptop.
- Your phone should now start up in Fastboot Mode after you press and hold the Volume Down + Power buttons for a few seconds. OnePlus 11R Recovery Mode and Fastboot Mode
- Using the ADB command, start OnePlus 11R in Bootloader Mode or Fastboot Mode.
...
- After some time, you will see that your OnePlus 11R has been hard reset.

### 2\. Hard reset with hardware key button

- Choose "wipe data/factory reset" on your OnePlus 11R to do a hard reset. Scroll down with the Volume buttons, and press the Power key to agree.
...
- Press and hold the Power and Volume Up buttons at the same time until the OnePlus 11R device vibrates. Release all the presses if the OnePlus 11R logo or Recovery screen shows.
...
**Step 1:** Connect your OnePlus 11R smartphone to your computer. Start Dr.Fone on your computer. Select "Data Eraser" from the tool list.

![drfone home page](https://images.wondershare.com/drfone/guide/drfone-home.png)

Connect your OnePlus 11R to the PC via a USB wire. Ensure that your phone has USB debugging turned on. You will see a pop-up window on your phone asking you to approve USB debugging.

![connect to device](https://images.wondershare.com/drfone/guide/android-erase-01.png)

**Step 2:** Begin wiping your OnePlus 11R phone.

Dr.Fone will then automatically recognize and connect to your OnePlus 11R smartphone. To begin wiping all of your data, select "Erase All Data.".
...
Dr. Fone will next proceed to wipe the data on your OnePlus 11R phone. The entire procedure takes only a few minutes. Turn off the phone and do not run any phone administration programs on the PC.
...
Your OnePlus 11R phone has now been completely wiped, giving it the appearance of being brand new.
...
**Step 1:** Connect your OnePlus 11R phone to your PC.

![drfone home page](https://images.wondershare.com/drfone/guide/drfone-home.png)

Launch Dr.Fone on your PC and choose "Phone Backup" from the list of options.

Then, connect your OnePlus 11R phone to the computer using a USB cord. Please ensure that the phone is in USB debugging mode. If your OnePlus 11R version is 4.2.2 or higher, a pop-up window on the OnePlus 11R phone will prompt you to accept USB Debugging. Please press the OK button.

![backup and restore](https://images.wondershare.com/drfone/guide/android-backup-and-restore-1.png)

To begin backing up the data on your OnePlus 11R phone, click Backup.
...
After connecting the OnePlus 11R phone, pick the file types you wish to back up. Dr.Fone has already tested all of the file kinds for you. Then, to begin the backup process, click Backup.

![file types](https://images.wondershare.com/drfone/drfone/android-data-backup-02.jpg)

The backup will take a few moments. Please do not detach your OnePlus 11R phone, use it, or erase any data from it during the backup process.
...
## All Things You Need to Know about Wipe Data/Factoy Reset For OnePlus 11R
...
Doing a factory reset on the Android device will remove all the applications installed on the OnePlus 11R device along with the data associated with them. This brings back all the default settings of the OnePlus 11R device as it was when the phone was new, giving you a clean slate to start all over again.
...
Step 1: First of all, turn off the OnePlus 11R device. Then, use the volume up button, volume down button, and Power button on your Android device simultaneously and hold on to the buttons until the phone turns on.

![boot in recovery mode](https://images.wondershare.com/drfone/article/2017/04/14925873397589.jpg)

Step 2: Release the buttons when the OnePlus 11R device is powered on. Now, use the volume up and down button to sift through the options given on the screen. Use the power button to select “Recovery Mode” on the screen. Your phone will restart into “Recovery Mode’ and you will find the below screen:
...
So, to protect your privacy and completely wipe data off the OnePlus 11R device, you can use Dr.Fone - Data Eraser. This is an amazing tool that erases everything on the OnePlus 11R device without leaving an ounce of data in it. Here’s how you can use [Dr.Fone - Data Eraser](https://tools.techidaily.com/wondershare/drfone/android-data-eraser/) to completely wipe the data and protect privacy:
